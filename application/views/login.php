  ...
  <head>
    ...
    @font-face {
      ...
      font-family: hiya;
			...
			.container{
				background-color: rgba(110, 126, 115, 0.4);
				width: 400px;
				height: 350px;
				margin-top: 150px;
				padding-left: 20px;
			...
			#masuk{
				background-color: rgba(110, 126, 115, 0.7);
				color: white;
				font-family: tayo;
				font-size: 18px;
				width: 150px;
	  	...
	  	<div class="container">
		      ...
		      <form class="form-login" action="<?=base_url('index.php/user/proses_login')?>" method="post">
		        ...
		        <div class="login-wrap">
		           ...
		           <br>
		            <input name="login" class="btn btn-theme btn-block"id="masuk" value="Masuk" type="submit">
		            <hr>
