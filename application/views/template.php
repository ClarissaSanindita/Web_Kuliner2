		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
                  ...
                  <li class="mt">
                      <a class="active" href="<?=base_url('index.php/dashboard')?>">
                  ...
                  <li class="sub-menu">
                      <a href="<?=base_url('index.php/makanan/toko')?>" >
                  ...
                  <?php if($this->session->userdata('level')=="admin"):?>
                          ...
                          <li><a  href="<?=base_url('index.php/makanan')?>">
														<i class="fa fa-desktop"></i>
	                          <span>Daftar makanan</span>
													</a></li>

													<li><a  href="<?=base_url('index.php/Kategori')?>">
                  ...
                  <li class="sub-menu">
                      <a href="<?=base_url('index.php/pesanan')?>" >
						...
						<li><a href="<?= base_url() ?>index.php/Transaksi" class="active"><i class="fa fa-shopping-cart"></i> <span>Transaksi</span></a></li>
						<?php }?>
